...
const nombres = ["Rodolfo", "Muzzarela", "Artilugia", "Wosito", "Calamardo"]
...
//   return (
//     {nombresGatos.map(elemento => <p>{elemento}</p>)}
//   )
// }
...
//   return (
//     <div>
//       {nombres.map(elemento => <BotonGato nombre={elemento} />)}
//     </div>
//   )
// }
...
const App = () => {
  ...
  return (
    <div className="contenedor-tarjetas">
      {gatos.map(elemento => <TarjetaGato 
      titulo={elemento.name}
      parrafo={elemento.shortDesc}
      imagen={elemento.img} />)}
    </div>
  )
}
